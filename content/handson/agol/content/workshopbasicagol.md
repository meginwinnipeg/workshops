...
![AGOL workspace](img/basic/estep1.PNG)<br>  
...
3. **Options** (pages for different purposes (your content, maps, etc.)  
	...
	![AGOL workspace](img/basic/estep2.PNG)<br>  
...
![AGOL workspace](img/basic/estep3a.PNG)<br>  
   
3. At the top of the page select the **Catalog** option, then the **Course Catalog**  
![AGOL workspace](img/basic/estep3b.PNG)<br>  
...
![AGOL workspace](img/basic/estep4a.PNG)<br>  
...
2. **Content** (where all of your data, objects and organizational content is stored)  
	![AGOL workspace](img/basic/estep5.PNG)<br>  
...
![AGOL workspace](img/basic/step1a.PNG)<br>  
...
![AGOL workspace](img/basic/step3c.PNG)<br>  
