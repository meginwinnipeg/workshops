...
![AGOL workspace](img/integrate/estep1.PNG)<br>  
...
3. **Options** (pages for different purposes (your content, maps, etc.)  
	...
	![AGOL workspace](img/integrate/estep2.PNG)<br>  
...
![AGOL workspace](img/integrate/estep3a.PNG)<br>  
   
3. At the top of the page select the **Catalog** option, then the **Course Catalog**  
![AGOL workspace](img/integrate/estep3b.PNG)<br>  
...
![AGOL workspace](img/integrate/estep4a.PNG)<br>  
...
2. **Content** (where all of your data, objects and organizational content is stored)  
	![AGOL workspace](img/integrate/estep5.PNG)<br>  
...
3. Using the search box search for _UM Campus Planning- Public Tree Inventory_ , click the title to see more details about the file.  
...
![AGOL workspace](img/integrate/step3d.PNG)<br>  
...
![AGOL workspace](img/integrate/step4d.PNG)<br>  
